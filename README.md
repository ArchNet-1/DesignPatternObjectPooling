...
<p align="center">
  ...
  <h3 align="center">Design Pattern Object Pooling</h3>
</p>
...
This is an object pooling design pattern for your gameobjects.
...
in Unity : Windows -> Package Manager -> + -> Add package from git url
2. Clone the repo
3. Create a new gameobject and give the ObjectPooler Script.
4. Set the max instance of the object to pool
5. Set the gameobject to pool
6. You have now set your design pattern for a generique purpose.
7. In your Controller Script, create a serialized field to drag your ObjectPooler script.
8. You have now access to your pooled gameobject in your controller :
- GetPooledObject ( return the queue objet )
- UpdatePooledObjects ( Update the design pattern )
